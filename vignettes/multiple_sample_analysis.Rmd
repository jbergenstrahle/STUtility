...
system.time({se <- LoadImages(object = se, verbose = T)})#, time.resolve = T)
...
ST.rgbDimPlot(plot = gg) %>% layout(paper_bgcolor = "rgb(0,0,0)") #make this an parameter  to St.DimPlot instead
...
se <- labelRGB(object = se, dimPlot = gg, 
                label1="orange", red1=c(85,255), green1=c(30,40), blue1=c(10,20),
...
#TODO: AAAAADDD det vore snyggt om man kunde VISUALISERA de REGIONER MAN VALT SO MAN VET !
