...
# TODO: Take care of warnings 
ImagePlot(se, method = "raster", type = "masked")

# Mirror image number 5 along y axis
transforms <- list("5" = list("mirror.y" = TRUE))
...
FeatureOverlay(object = se, features = c("Nrgn", "Cck"), palette = "GrRd")
...
# Plot HE images
par(mar = c(0, 0, 0, 0))
se <- ImagePlot(se, method = "raster", ncols = 4)
