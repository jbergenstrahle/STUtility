...
# TODO: Take care of warnings 
ImagePlot(se, method = "raster", type = "processed.masks")

# Mirror image number 5 along y axis
transforms <- list("5" = list("mirror.y" = FALSE))
...
FeatureOverlay(object = se, features = c("Nrgn", "Cck"), palette = "GrRd", sample.index = 5, type = "processed.masks")
