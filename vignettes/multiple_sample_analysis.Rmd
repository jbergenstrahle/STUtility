...
To follow along this tutorial, download the test data set at [insert test data set link]. The downloadable content consists of count files, output from our spot detector tool, H&E stained images as well as an "infoTable" to read in the files into R.
...
[har skulle man vilja ha en jamforelse? som del i pek?] 
...
NOTE: see section [What if I don't have spot file coordinates?] at the end of the vignette if you are missing spot files. 
...
see section - rgb dim.red space etc. 
