...
cm <- RunPCA(cm, ndims.print = 3, nfeatures.print = 5)
cm <- RunICA(cm, ndims.print = 3, nfeatures.print = 5)
...
ST.DimPlot(object = cm, dims = 1:4, dark.theme = T)
...
ST.FeaturePlot(object = cm, 
               ...
               dark.theme = T, ncol = 4, grid.ncol = 1, center.zero = T, palette = "RdBu", rev.cols = F, center.tissue = T)
