...
ST.FeaturePlot(object = se, features = "seurat_clusters", dark.theme = T, cols = tol18rainbow, pt.size = 0.5)
...
ST.FeaturePlot(object = se, features = "seurat_clusters", dark.theme = T, cols = tol18rainbow, pt.size = 0.1, split.labels = T, indices = 1)
...
heatmap.colors <- c(rgb(20, 20, 20, maxColorValue = 255), "dark blue", "cyan", "white")
fts <- c("Slc18a2", "Prkcd", "Opalin", "Lamp5")
